...
public class RipTest {
    ...
    public static void print(Transaction aTx, Object aObject, String outputFile) throws IOException {
        @SuppressWarnings("unchecked")
        Resource<Object> o = (Resource<Object>) aObject;
        IKind<Object> kind = (IKind<Object>) o.id().kind();
    ...
    @Test
    public void retrieve() throws IllegalArgumentException, Exception {
        System.out.println("retrieve");
        Transaction t = repo().connect(this);
        Person p = t.retrieve("Person", "1");
        print(t, p);
        t.close();
    }

    public void retrieve(int i) throws IllegalArgumentException, Exception {
        Transaction t = repo().connect(this);
    ...
    public void testURI1() throws Exception {
        System.out.println("testuri1");
        URI uri = new URI("http://localhost:8080/this/is/a/service/retrieve/Person-10");
        System.out.println(uri.resolve("Geo-3"));
    }

    @Test
    public void testURI2() throws Exception {
        System.out.println("testuri2");
        URI uri = new URI("ans://res.test.objectof.org:1401/this.is.a.repo/Person-10");
        System.out.println(uri.resolve("Geo-3"));
    }

    @Test
    public void testURI3() throws Exception {
        System.out.println("testuri3");
        URI uri = new URI("ans://res.test.objectof.org:1401/this.is.a.repo");
        System.out.println(uri.relativize(new URI("ans://res.test.objectof.org:1401/this.is.a.repo/Geo/3")));
    }
    ...
    public void textTest() throws Exception {
        ...
        IRip repo = (IRip) repo();
        String test = "test_text_" + System.currentTimeMillis();
        long txtid = repo.internString(test);
        String chars = repo.getText(txtid);
        Assert.assertEquals(test, chars);
    }

    @Test
    public void update() throws IllegalArgumentException, Exception {
    ...
    // @Test
    public void updateList() throws IllegalArgumentException, Exception {
    ...
    @Test
    public void useBean() throws IllegalArgumentException, Exception {
    ...
    protected void createbulk(int aNumber) throws Exception {
        // Create a transaction to do something. Identify the user performing
        // the
        // transaction:
        Transaction t = repo().connect(this);
    ...
    protected void createPersonLocations(Transaction aTransaction, IPersonBean aPerson) {
        // Create locations
        ...
        for (int j = 0; j < 4; j++) {
            Location loc = aTransaction.<Resource<Location>> create("Person.locations.location").value();
