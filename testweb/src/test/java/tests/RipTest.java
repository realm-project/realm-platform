...
public class RipTest
{
  ...
  public void testURI1() throws Exception
  {
    ...
    URI uri = new URI(
        "http://localhost:8080/this/is/a/service/retrieve/Person-10");
  ...
  public void testURI2() throws Exception
  {
    ...
    URI uri = new URI(
        "ans://res.test.objectof.org:1401/this.is.a.repo/Person-10");
    System.out.println(uri.resolve("Geo-3"));
  }
  ...
  public void testURI3() throws Exception
  {
    ...
    System.out.println(uri.relativize(new URI(
        "ans://res.test.objectof.org:1401/this.is.a.repo/Geo/3")));
  }
  ...
  protected Person createPerson(Transaction aTransaction,
      long aEmpno)
  {
