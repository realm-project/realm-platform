...
import net.realmproject.util.model.Courses;
import net.realmproject.util.model.DeviceUIs;
...
import net.realmproject.util.model.Students;
import net.realmproject.util.model.Teachers;
