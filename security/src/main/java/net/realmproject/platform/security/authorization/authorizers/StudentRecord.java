...
public class StudentRecord extends RecordAuthorizer {
    ...
    public StudentRecord(Connector connector) throws ConnectorException {
        super(connector);
    }
    ...
    // students can access assignments for sessions they are part of or for
    // courses they're part of
