...
import net.realmproject.platform.settings.Setting;
...
public class Settings {
	...
	public Settings(String appname) throws ConnectorException {
        ...
        String dbfile = System.getProperty("user.home") + "/.realm/applications/" + appname + "/settings.db";
	...
	public void put(String key, String value) {
		...
		if (setting == null) { setting = createSetting(key); }
