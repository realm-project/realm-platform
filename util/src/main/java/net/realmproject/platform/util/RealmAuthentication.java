...
public class RealmAuthentication {
	...
	public static String hash(String password, String salt) {
		try {
			...
			e.printStackTrace();
			throw new IllegalArgumentException(e); //is a runtime exception preferred?
		}
	}
	
	public static boolean authenticate(String password, String currentHash, String currentSalt) throws InterruptedException {
