...
public class ISqlDb extends IFn implements Context<Package>
{
  ...
  public Package createPackage(String aUniqueName, String aImpl,
      IPackage aPackage)
  {
  ...
  protected Package definePackage(String aUniqueName, String aImpl)
  {
    try
    {
      ...
      Constructor<Package> constr = cls
          .getConstructor(getClass(), String.class);
